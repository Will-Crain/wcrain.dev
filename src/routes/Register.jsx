		...
		<section className='flex h-screen flex-col items-center justify-center w-full px-4 sm:w-[40rem]' id='register'>
			<div className='w-full bg-white rounded-lg shadow-md dark:border dark:bg-gray-800 dark:border-gray-700'>
				...
				<form onSubmit={handleSubmit} className='w-full flex flex-col p-4 gap-4 items-center'>
					<div className='flex flex-row w-96 content-between'>
					...
					<div className='flex flex-row w-96 justify-center items-center'>
					...
					<input name="email" value={formData.email} onChange={handleInputChange} placeholder='Email' type='email' className='h-10 w-96 p-2 mx-2 bg-gray-50 border border-gray-100 text-black rounded-lg'></input>
					<input name="password" value={formData.password} onChange={handleInputChange} placeholder='Password' type='password' className='h-10 w-96 p-2 mx-2 bg-gray-50 border border-gray-100 text-black rounded-lg'></input>
					<input name="confirmation" value={formData.confirmation} onChange={handleInputChange} placeholder='Confirm' type='password' className='h-10 w-96 p-2 mx-2 bg-gray-50 border border-gray-100 text-black rounded-lg'></input>
					...
					<div className='flex flex-col w-96 justify-center items-center'>
						...
						<input name="code" value={formData.code} onChange={handleInputChange} placeholder='Code' className='w-96 p-2 mr-0 mx-2 bg-gray-50 border border-gray-100 text-black rounded-lg'></input>
					</div>
