...
const Pair = (props) => {
  ...
  let appNameLookup = {
    ...
    'expenseTracker': 'Shared Expenses Tracker',
  }
  return (
    <section className='flex h-screen flex-col items-center justify-center w-full px-4 sm:w-[40rem]' id='alert'>
      <div className='w-full bg-white rounded-lg shadow-md dark:border dark:bg-gray-800 dark:border-gray-700'>
        ...
        <form onSubmit={handleSubmit} className='w-full flex flex-col p-4 gap-4 items-center'>
          ...
          <p className='px-2 text-center text-xs h-auto'>The application you're trying to access requires the linking of two accounts. The user you wish to link to can access their UserID from their Profile page. You may enter their UserID below. Upon submitting, you shall be redirected and your connected partner may navigate to the App.</p>
